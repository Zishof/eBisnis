...
export class PesantrenDapodikController {
  ...
  @Permissions('EPESANTREN_DAPODIK.READ')
  @Get('batches')
  @ApiOperation({ summary: 'Riwayat batch import Dapodik' })
  ...
  @Permissions('EPESANTREN_DAPODIK.READ')
  @Get('batches/:batchId')
  @ApiOperation({ summary: 'Detail baris batch import Dapodik' })
  ...
  @HttpCode(200)
  @ApiOperation({ summary: 'Rollback aman batch import Dapodik' })
