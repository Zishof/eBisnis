...
export const SALES_INVENTORY_PARITY: InventoryParityItem[] = [
  ...
  item(9, 'Laporan Opname Stok', 'STOCK_PRICE', ['/stock-opnames', '/inventory/legacy/stock-opname'], 'READ_ONLY', 'CONTRACT_ONLY'),
  ...
  item(17, 'Menu Master Harga', 'STOCK_PRICE', ['/inventory/legacy/price-history'], 'READ_ONLY', 'CONTRACT_ONLY'),
  item(18, 'Master Harga Beli per Supplier', 'STOCK_PRICE', ['/inventory/legacy/price-history'], 'READ_ONLY', 'CONTRACT_ONLY'),
  item(19, 'Master Harga Jual per Customer', 'STOCK_PRICE', ['/inventory/legacy/price-history'], 'READ_ONLY', 'CONTRACT_ONLY'),
