...
export const EDUCATION_GAP_MODULES: EducationGapModule[] = [
  ...
  },
  {
    ...
    status: 'SEBAGIAN',
    priority: 'P0',
    summary: 'Rombel, kurikulum, jadwal, komponen nilai, skala huruf, input nilai, finalisasi snapshot rapor, PDF resmi ber-QR, verifikasi publik, leger/ranking, export leger DAPODIK/EMIS, dan keputusan akademik.',
    ...
    nextAction: 'Tambah template rapor per jenjang dan validasi bentrok jadwal lanjutan.',
...
export const EDUCATION_ROADMAP: EducationRoadmapItem[] = [
  {
    ...
    items: [
      'Template rapor per jenjang dan validasi jadwal lanjutan di atas snapshot finalisasi.',
