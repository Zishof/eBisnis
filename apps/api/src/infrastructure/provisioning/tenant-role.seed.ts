...
export const ROLE_CATALOG: RoleCatalogEntry[] = [
  ...
  // -------------------------------------------------------------------- POS
  //
  // Modul POS memakai profil K1–K4, bukan P1–P12. Alasannya ada pada
  // role-profile.ts: hak menyetujui refund dan memindahkan kas tidak boleh
  // merembes ke modul lain hanya karena seseorang manajer modul di tempat lain.
  r('KASIR_POS', 'Kasir POS', 'POS', 'K1',
    { POS: 'K1', CATALOG: 'P1', CRM: 'P2' }, 'OUTLET_TERMINAL',
  ...
  r('SUPERVISOR_KASIR', 'Supervisor Kasir', 'POS', 'K2',
    { POS: 'K2', SALES: 'P2', FINANCE: 'P1' }, 'OUTLET',
    'Shift, void, refund, dan rekonsiliasi. Tidak mengubah setelan akuntansi.',
    { core: true, sodGroup: 'POS_VOID', sodSide: 'APPROVER' }),
  r('KEPALA_TOKO', 'Kepala Toko', 'Retail', 'K3',
    { POS: 'K3', SALES: 'P6', INVENTORY: 'P5', HR: 'P2', REPORTING: 'P1' }, 'OUTLET',
    'Satu atau lebih outlet. Pembayaran dan penyesuaian stok dibatasi ambang.',
    { core: true }),
  r('ADMIN_TOKO', 'Administrator Toko', 'Retail', 'K5',
    { POS: 'K5', CATALOG: 'P5', REPORTING: 'P1' }, 'OUTLET',
    'Master terminal, penugasan register, dan setelan outlet. TIDAK berjualan dan tidak menyentuh kas — yang menyiapkan alat dipisahkan dari yang memakainya.',
    { core: true, sodGroup: 'POS_CASH', sodSide: 'CUSTODIAN' }),
  r('PETUGAS_GUDANG_OUTLET', 'Petugas Gudang Outlet', 'Retail', 'P2',
    { INVENTORY: 'P2', CATALOG: 'P1', POS: 'P1' }, 'OUTLET',
    'Stok, penerimaan, dan opname pada outlet sendiri. Melihat penjualan tanpa dapat bertransaksi.'),
  r('AUDITOR_POS', 'Auditor POS', 'Audit', 'K4',
    { POS: 'K4', SALES: 'P9', FINANCE: 'P9', REPORTING: 'P1' }, 'TENANT',
    'Membaca seluruh transaksi kasir, shift, kas, dan jejak auditnya — termasuk harga pokok. Tidak mengubah apa pun.',
    { sodGroup: 'POS_CASH', sodSide: 'APPROVER' }),
  ...
  r('ADMIN_ECOMMERCE', 'Administrator E-commerce', 'E-commerce', 'P7',
    { CATALOG: 'P7', SALES: 'P6', CRM: 'P5',
      ONLINE_STORE: 'M7', ONLINE_CATALOG: 'M7', ONLINE_SALES: 'M6',
      MARKETPLACE_HOME: 'M6', MARKETPLACE_ACTIVATION: 'M2', MARKETPLACE_PROMO: 'M6' },
    'BRAND',
  ...
  r('KEPALA_GUDANG', 'Kepala Gudang', 'Warehouse', 'P6',
    { INVENTORY: 'P6', PURCHASING: 'P5', SHIPPING: 'P2',
      FULFILLMENT: 'M6', ALLOCATION: 'M1' }, 'WAREHOUSE',
  ...
  r('MANAJER_LOGISTIK', 'Manajer Logistik', 'Logistics', 'P6',
    ...
    // Root SHIPPING diperluas Versi 9, sehingga menu provider, booking, dan
    // pelacakan otomatis terwarisi tanpa mengubah baris ini.
  ...
  // ============================== Versi 9 — Marketplace platform ==========
  r('ADMIN_MARKETPLACE_PLATFORM', 'Administrator Marketplace Platform', 'Marketplace Platform', 'M8',
    { MARKETPLACE_PLATFORM: 'M8', MARKETPLACE_HOME: 'M8', ONLINE_CATALOG: 'M8', ONLINE_SALES: 'M8' },
    'PLATFORM',
    'Seluruh operasi marketplace platform. Credential seller tetap tidak terlihat utuh.',
    { platformOnly: true }),
  r('MANAJER_OPERASI_MARKETPLACE', 'Manajer Operasional Marketplace', 'Marketplace Platform', 'M8',
    { MARKETPLACE_PLATFORM: 'M8', ONLINE_SALES: 'M6', FULFILLMENT: 'M1' }, 'PLATFORM',
    'Seller, pesanan, SLA, dan moderasi. Fee dan credential pembayaran terpisah.',
    { platformOnly: true }),
  r('PETUGAS_AKTIVASI_ESMARTLINK', 'Petugas Aktivasi eSmartlink', 'Marketplace Platform', 'M6',
    { MARKETPLACE_ACTIVATION: 'M6', SUPPORT: 'M6' }, 'ASSIGNED_QUEUE',
    'Tiket aktivasi dan health check. Tidak melihat credential setelah tersimpan.',
    { platformOnly: true, sodGroup: 'ESMARTLINK_CREDENTIAL', sodSide: 'PREPARER' }),
  r('ADMIN_PEMBAYARAN_MARKETPLACE', 'Administrator Pembayaran Marketplace', 'Marketplace Platform', 'M8',
    { MARKETPLACE_PAYMENT: 'M8', MARKETPLACE_PLATFORM: 'M1' }, 'PAYMENT_PROVIDER_ACCOUNT',
    'Provider, akun, callback, dan inquiry. Persetujuan refund terpisah.',
    { platformOnly: true, sodGroup: 'ESMARTLINK_CREDENTIAL', sodSide: 'CUSTODIAN' }),
  r('PETUGAS_REKONSILIASI_MARKETPLACE', 'Petugas Rekonsiliasi Marketplace', 'Marketplace Platform', 'M6',
    { MARKETPLACE_PAYMENT: 'M6' }, 'PAYMENT_PROVIDER_ACCOUNT',
    'Rekonsiliasi pembayaran per periode. Tidak mengubah callback mentah.',
    { platformOnly: true, sodGroup: 'PAYMENT_RECONCILE', sodSide: 'APPROVER' }),
  r('MODERATOR_PRODUK_MARKETPLACE', 'Moderator Produk Marketplace', 'Marketplace Platform', 'M8',
    { MARKETPLACE_PLATFORM: 'M8', ONLINE_CATALOG: 'M6' }, 'ASSIGNED_QUEUE',
    'Moderasi listing dan media. Tidak memoderasi listing tenant sendiri.',
    { platformOnly: true, sodGroup: 'MODERATION_CONFLICT', sodSide: 'APPROVER' }),
  r('PETUGAS_KEPATUHAN_MARKETPLACE', 'Petugas Kepatuhan Marketplace', 'Marketplace Platform', 'M8',
    { MARKETPLACE_PLATFORM: 'M8' }, 'PLATFORM',
    'Produk terlarang, terbatas, dan kepatuhan kategori. Tidak memproses pesanan.',
    { platformOnly: true }),
  r('ANALIS_RISIKO_MARKETPLACE', 'Analis Risiko Marketplace', 'Marketplace Platform', 'M1',
    { MARKETPLACE_PLATFORM: 'M1', MARKETPLACE_PAYMENT: 'M1', ONLINE_SALES: 'M1' }, 'PLATFORM',
    'Sinyal fraud, peringatan, dan kasus risiko. Tidak mengeksekusi refund.',
    { platformOnly: true }),
  r('PETUGAS_SENGKETA_MARKETPLACE', 'Petugas Sengketa Marketplace', 'Marketplace Platform', 'M8',
    { RETURN_REFUND: 'M8', ONLINE_SALES: 'M1' }, 'ASSIGNED_QUEUE',
    'Sengketa, bukti, dan keputusan. Tidak memutus kasus yang ia buat sendiri.',
    { platformOnly: true, sodGroup: 'DISPUTE_CONFLICT', sodSide: 'APPROVER' }),
  r('ADMIN_KATEGORI_MARKETPLACE', 'Administrator Kategori Marketplace', 'Marketplace Platform', 'M7',
    { MARKETPLACE_PLATFORM: 'M7', ONLINE_CATALOG: 'M1' }, 'PLATFORM',
    'Kategori dan atribut marketplace. Tidak menyetujui listing sendiri.',
    { platformOnly: true }),
  r('MANAJER_KAMPANYE_MARKETPLACE', 'Manajer Kampanye Marketplace', 'Marketplace Platform', 'M7',
    { MARKETPLACE_PROMO: 'M7', MARKETPLACE_PLATFORM: 'M1' }, 'PLATFORM',
    'Kampanye, voucher, dan subsidi platform. Anggaran menuntut persetujuan.',
    { platformOnly: true, sodGroup: 'FEE_APPROVAL', sodSide: 'PREPARER' }),
  r('ANALIS_MARKETPLACE_PLATFORM', 'Analis Marketplace Platform', 'Marketplace Platform', 'M1',
    { MARKETPLACE_PLATFORM: 'M1', STORE_PERFORMANCE: 'M1' }, 'PLATFORM',
    'Dashboard dan laporan platform. Hanya baca.', { platformOnly: true }),

  // ============================== Versi 9 — Marketplace tenant ============
  r('ADMIN_TOKO_ONLINE', 'Administrator Toko Online', 'Marketplace', 'M7',
    {
      MARKETPLACE_HOME: 'M7', MARKETPLACE_ACTIVATION: 'M7', ONLINE_STORE: 'M7',
      ONLINE_CATALOG: 'M7', ONLINE_SALES: 'M7', MARKETPLACE_PAYMENT: 'M1',
      ALLOCATION: 'M6', FULFILLMENT: 'M6', SHIPPING: 'M6', RETURN_REFUND: 'M6',
      MARKETPLACE_PROMO: 'M7', MARKETPLACE_CUSTOMER: 'M6', STORE_PERFORMANCE: 'M1',
      MARKETPLACE_HELP: 'M1', SUPPORT_TICKET: 'M2',
    }, 'STORE',
    'Seluruh pusat penjual. Credential hanya bila diberikan lewat role terpisah.',
    { core: true }),
  r('MANAJER_TOKO_ONLINE', 'Manajer Toko Online', 'Marketplace', 'M6',
    {
      MARKETPLACE_HOME: 'M6', ONLINE_STORE: 'M2', ONLINE_CATALOG: 'M6',
      ONLINE_SALES: 'M6', MARKETPLACE_PAYMENT: 'M1', FULFILLMENT: 'M6',
      SHIPPING: 'M1', RETURN_REFUND: 'M6', MARKETPLACE_PROMO: 'M6',
      MARKETPLACE_CUSTOMER: 'M1', STORE_PERFORMANCE: 'M1', MARKETPLACE_HELP: 'M1',
    }, 'BRAND',
    'Pesanan, listing, promo, dan laporan. Tidak mengubah aturan akuntansi.'),
  r('ADMIN_ESMARTLINK_TENANT', 'Administrator eSmartlink Tenant', 'Marketplace', 'M7',
    // M9, bukan M7: M7 sengaja tidak memuat MANAGE_CREDENTIAL agar admin toko
    // tidak memperolehnya. Hak itu hanya berlaku pada modul aktivasi.
    { MARKETPLACE_ACTIVATION: 'M9', MARKETPLACE_PAYMENT: 'M6', SUPPORT_TICKET: 'M2' },
    'PAYMENT_PROVIDER_ACCOUNT',
    'Credential, uji, dan health check akun pembayaran. Step-up wajib; tidak menyetujui refund.',
    { sodGroup: 'ESMARTLINK_CREDENTIAL', sodSide: 'CUSTODIAN' }),
  r('PENGELOLA_KATALOG_ONLINE', 'Pengelola Katalog Online', 'Marketplace', 'M3',
    { ONLINE_CATALOG: 'M3', ONLINE_STORE: 'M1', MARKETPLACE_HELP: 'M1' }, 'BRAND',
    'Listing, harga, stok, dan media. Publikasi dapat menuntut persetujuan.',
    { sodGroup: 'LISTING_PUBLISH', sodSide: 'PREPARER' }),
  r('EDITOR_KONTEN_PRODUK', 'Editor Konten Produk', 'Marketplace', 'M2',
    { ONLINE_CATALOG: 'M2', MARKETPLACE_HELP: 'M1' }, 'BRAND',
    'Judul, deskripsi, dan SEO listing. Tidak mengubah harga maupun biaya.'),
  r('PETUGAS_MEDIA_PRODUK', 'Fotografer dan Media Produk', 'Marketplace', 'M3',
    { ONLINE_CATALOG: 'M3' }, 'BRAND',
    'Gambar dan video produk. Tidak menerbitkan listing.'),
  r('PENYETUJU_LISTING_ONLINE', 'Penyetuju Listing Online', 'Marketplace', 'M6',
    { ONLINE_CATALOG: 'M6', ONLINE_STORE: 'M1' }, 'BRAND',
    'Tinjau dan terbitkan listing. Tidak menyetujui listing buatannya sendiri.',
    { sodGroup: 'LISTING_PUBLISH', sodSide: 'APPROVER' }),
  r('OPERATOR_PESANAN_ONLINE', 'Operator Pesanan Online', 'Marketplace', 'M2',
    { ONLINE_SALES: 'M2', ONLINE_CATALOG: 'M1', MARKETPLACE_PAYMENT: 'M1', RETURN_REFUND: 'M2' },
    'STORE',
    'Konfirmasi dan status pesanan. Tidak menyetujui refund.',
    { core: true, sodGroup: 'PAYMENT_RECONCILE', sodSide: 'PREPARER' }),
  r('KOORDINATOR_FULFILLMENT_ONLINE', 'Koordinator Fulfillment Online', 'Marketplace', 'M6',
    { FULFILLMENT: 'M6', ALLOCATION: 'M6', ONLINE_SALES: 'M1', SHIPPING: 'M6' },
    'FULFILLMENT_LOCATION',
    'Routing, picking, packing, dan SLA. Tidak mengubah harga maupun pembayaran.'),
  r('PICKER_PESANAN_ONLINE', 'Picker Pesanan Online', 'Marketplace', 'M4',
    { FULFILLMENT: 'M4', ONLINE_CATALOG: 'M1', ONLINE_SALES: 'M1' }, 'WAREHOUSE',
    'Tugas pengambilan dan pemindaian. Tidak membuat penyesuaian stok.',
    { sodGroup: 'PICK_STOCK_ADJUST', sodSide: 'EXECUTOR' }),
  r('PACKER_PESANAN_ONLINE', 'Packer Pesanan Online', 'Marketplace', 'M4',
    { FULFILLMENT: 'M4', SHIPPING: 'M4', ONLINE_SALES: 'M1' }, 'WAREHOUSE',
    'Pengemasan, paket, dan label. Tidak mengubah pesanan.',
    { sodGroup: 'PACK_ORDER_EDIT', sodSide: 'EXECUTOR' }),
  r('ADMIN_PENGIRIMAN_ONLINE', 'Administrator Pengiriman Online', 'Marketplace', 'M7',
    { SHIPPING: 'M7', FULFILLMENT: 'M1', ONLINE_SALES: 'M1', RETURN_REFUND: 'M1' }, 'STORE',
    'Quote, booking, manifest, dan pelacakan. Credential provider dapat dipisah.'),
  r('PETUGAS_SHIPMENT_ONLINE', 'Petugas Pengiriman Online', 'Marketplace', 'M4',
    // ASSIGNED_QUEUE, bukan tingkat "ASSIGNED_TASK" tersendiri: keduanya
    // bermakna sama — hanya pekerjaan yang ditugaskan kepadanya — dan menambah
    // tingkat kedua hanya menghasilkan dua nama untuk satu aturan.
    { SHIPPING: 'M4', FULFILLMENT: 'M1' }, 'ASSIGNED_QUEUE',
    'Pickup, dropoff, dan pelacakan kiriman yang ditugaskan. Tidak mengubah pembayaran.'),
  r('PETUGAS_RETUR_MARKETPLACE', 'Petugas Retur Marketplace', 'Marketplace', 'M6',
    { RETURN_REFUND: 'M6', ONLINE_SALES: 'M1', FULFILLMENT: 'M1' }, 'WAREHOUSE',
    'Penerimaan dan inspeksi retur. Persetujuan refund mengikuti ambang.',
    { sodGroup: 'MARKETPLACE_REFUND', sodSide: 'PREPARER' }),
  r('PENYETUJU_REFUND_MARKETPLACE', 'Penyetuju Refund Marketplace', 'Marketplace', 'M6',
    { MARKETPLACE_PAYMENT: 'M6', RETURN_REFUND: 'M6', ONLINE_SALES: 'M1' }, 'STORE',
    'Keputusan refund. Tidak membuat permintaan refund yang ia setujui sendiri.',
    { sodGroup: 'MARKETPLACE_REFUND', sodSide: 'APPROVER' }),
  r('LAYANAN_PELANGGAN_MARKETPLACE', 'Layanan Pelanggan Marketplace', 'Marketplace', 'M5',
    { MARKETPLACE_CUSTOMER: 'M5', ONLINE_SALES: 'M1', RETURN_REFUND: 'M5', SUPPORT_TICKET: 'M2' },
    'ASSIGNED_QUEUE',
    'Chat, status pesanan, dan permintaan retur. Data pribadi tersamar; tidak menyetujui refund.',
    { sodGroup: 'CS_CREDENTIAL', sodSide: 'EXECUTOR' }),
  r('MODERATOR_CHAT_REVIEW_TENANT', 'Moderator Chat dan Review Tenant', 'Marketplace', 'M6',
    { MARKETPLACE_CUSTOMER: 'M6' }, 'STORE',
    'Chat, ulasan, dan laporan penyalahgunaan. Tidak menghapus audit.'),
  r('MANAJER_PROMO_MARKETPLACE', 'Manajer Promo Marketplace', 'Marketplace', 'M7',
    { MARKETPLACE_PROMO: 'M7', ONLINE_CATALOG: 'M1', STORE_PERFORMANCE: 'M1' }, 'BRAND',
    'Voucher, promo, dan kampanye toko. Anggaran dan diskon mengikuti ambang.'),
  r('SPESIALIS_LIVE_COMMERCE', 'Spesialis Live Commerce', 'Marketplace', 'M2',
    { MARKETPLACE_PROMO: 'M2', ONLINE_CATALOG: 'M1' }, 'STORE',
    'Konten siaran dan penyematan produk. Tidak mengubah pembayaran.'),
  r('MANAJER_AFFILIATE_MARKETPLACE', 'Manajer Affiliate Marketplace', 'Marketplace', 'M7',
    { MARKETPLACE_PROMO: 'M7', STORE_PERFORMANCE: 'M1' }, 'STORE',
    'Program afiliasi, tautan, dan komisi. Perubahan tarif menuntut persetujuan.'),
  r('ANALIS_TOKO_ONLINE', 'Analis Toko Online', 'Marketplace', 'M1',
    { STORE_PERFORMANCE: 'M1', ONLINE_SALES: 'M1', ONLINE_CATALOG: 'M1' }, 'BRAND',
    'Analitik dan laporan toko. Hanya baca.'),
  r('AUDITOR_MARKETPLACE', 'Auditor Marketplace', 'Marketplace', 'P9',
    {
      MARKETPLACE_HOME: 'P9', ONLINE_CATALOG: 'P9', ONLINE_SALES: 'P9',
      MARKETPLACE_PAYMENT: 'P9', FULFILLMENT: 'P9', SHIPPING: 'P9', RETURN_REFUND: 'P9',
    }, 'TENANT',
    'Hanya baca atas seluruh jejak marketplace. Tanpa perubahan apa pun.'),
