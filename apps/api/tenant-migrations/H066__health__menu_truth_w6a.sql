-- =========================================================================
-- H066 - MENU BERLAYAR W-6A
-- =========================================================================
--
-- Fase W-6A membuka eMAR pada `/app/emedik/pemberian`.
--
-- Ini dilakukan lebih dulu daripada master data karena ia kerja harian
-- perawat/farmasi klinis: obat yang diberikan, ditahan, ditolak, atau dilewati
-- harus tercatat dengan alasan. Layar eMAR tidak menggantikan pemeriksaan
-- peladen; scan pasien, scan obat, dosis, rute, waktu, dan dokumentasi tetap
-- divalidasi di API.
...
BEGIN
  ...
  IF tak_dikenal <> '' THEN
    RAISE EXCEPTION
      'H066: utas berikut tidak cocok dengan menu mana pun: %. Utas yang salah ketik akan '
  ...
  RAISE NOTICE 'H066: % menu berlayar, % menu masih segera hadir.', n_siap, n_belum;
END $$;
