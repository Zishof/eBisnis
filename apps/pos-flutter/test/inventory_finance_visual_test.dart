...
class _FinanceVisualClient extends InventoryApiClient {
  ...
  @override
  Future<InventoryFinanceData> financeWorkspace() async => const InventoryFinanceData(
        accounts: [
          FinanceAccount('a1', '101', 'Kas', 'ASSET', 'DEBIT', true),
          FinanceAccount('a2', '102', 'Piutang Dagang', 'ASSET', 'DEBIT', true),
          FinanceAccount('a3', '202', 'Hutang Dagang', 'LIABILITY', 'CREDIT', true),
          FinanceAccount('a4', '400', 'Pendapatan Penjualan', 'REVENUE', 'CREDIT', true),
        ],
        periods: [
          FinancePeriod('p1', '2026-08', 'Agustus 2026', '2026-08-01', '2026-08-31', 'OPEN'),
        ],
        journals: [
          FinanceJournal('j1', 'JRN-20260806-001', '2026-08-06', 'Penerimaan pelanggan', 'POSTED', 850000, 850000),
          FinanceJournal('j2', 'JRN-20260806-002', '2026-08-06', 'Pembelian tunai', 'DRAFT', 425000, 425000),
        ],
        closeRuns: [],
      );
}
...
void main() {
  testWidgets('bukti visual kas jurnal dan keuangan desktop', (tester) async {
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/inventory-finance-desktop.png'),
    );
  });
}
