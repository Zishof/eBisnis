...
const photos = {
  ...
  route: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=82',
  pharmacy: 'https://images.unsplash.com/photo-1576602976047-174e57a47881?auto=format&fit=crop&w=1200&q=82',
};
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-6">
          <div className="grid gap-6 lg:grid-cols-[360px_minmax(0,1fr)] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600 dark:text-slate-300">
                Best practice landing SaaS yang dipakai di sini: pesan utama spesifik, CTA jelas, visual nyata,
