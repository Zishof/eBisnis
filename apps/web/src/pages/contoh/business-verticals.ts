...
export const BUSINESS_VERTICALS: BusinessVertical[] = [
  ...
  },
  {
    ...
    audience: 'Distributor barang, sales keliling, toko pelanggan, gudang, dan pemilik usaha',
    headline: 'Sales keliling dan inventory terintegrasi dari kunjungan toko sampai dashboard pemilik.',
    description:
      'Cocok untuk distributor FMCG, sembako, kosmetik, alat teknik, bahan bangunan, pertanian, suku cadang, dan barang dagang lain dengan order per toko, harga pelanggan, stok, piutang, serta laporan per sales.',
    imageUrl: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=1400&q=82',
    imageAlt: 'Gudang distribusi dan pengelolaan inventory barang',
    color: 'teal',
    metrics: [
      { label: 'Jenis produk', value: 'Multi-industri', note: 'sesuai bisnis tenant' },
      { label: 'Kanal kerja', value: '3 platform', note: 'web, Android, Windows' },
      { label: 'Kontrol usaha', value: 'Real-time', note: 'sales, stok, tagihan' },
    ],
    workflows: ['Rute dan kunjungan', 'Order toko', 'Cek stok', 'Penagihan dan pembayaran'],
    features: ['Dashboard owner', 'Laporan per sales', 'Harga khusus pelanggan', 'Supplier dan pembelian', 'Stok opname', 'Aging piutang'],
    sampleData: [
