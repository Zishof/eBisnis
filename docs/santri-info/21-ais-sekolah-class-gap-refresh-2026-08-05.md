...
| Impor/ekspor Dapodik | Pola AIS memakai banyak helper Excel/POI pada modul sekolah | Dilengkapi batch ini: pusat `Impor/Ekspor Dapodik` untuk santri, guru, mata pelajaran, rombongan, kurikulum, jadwal, komponen nilai, dan nilai; tersedia template CSV, ekspor CSV, validasi dry-run, dan impor final | Mapper alias untuk variasi file Dapodik asli dari sekolah perlu diperkaya setelah ada contoh file produksi |
...
- Pusat Dapodik ditambahkan: template CSV, ekspor CSV, validasi dry-run, dan impor final untuk santri, guru, mata pelajaran, rombongan, kurikulum, jadwal, komponen nilai, dan nilai.
